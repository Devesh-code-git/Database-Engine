...
#define LEAF_MAX 338 // Maximum amount of keys a leaf node can have
#define LEAF_MIN 169
...
typedef struct {
	...
	Page prev_leaf; // Points to leaf node thats to the left of it
} LeafNode;
...
// Functions for creating and deleting related data
